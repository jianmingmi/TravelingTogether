...
<blockquote class="layui-elem-quote" style="margin-left: 10px;margin-top: 10px;">用户模块</blockquote>

<button class="layui-btn" style="margin-left: 10px;" onclick="javascript:changeCurContent('/jsp/user/form.jsp')">添加
</button>
...
<table class="layui-table" lay-even="" lay-skin="row" style="width: 98%;margin-left: 10px;">
    ...
    <%
        List<User> beans = (List<User>) request.getAttribute("beans");
    ...
    <tr>
        ...
        <td style="text-overflow:ellipsis; white-space:nowrap;overflow: hidden;">
            <button class="layui-btn layui-btn-small layui-btn-primary"
                    onclick="javascript:changeCurContent('/user/getBeanById/<%=bean.getInt("id")%>')">
                <i class="layui-icon">&#xe642;</i>
            </button>
            <button class="layui-btn layui-btn-small layui-btn-primary"
                    onclick="javascript:changeCurContent('/user/del/<%=bean.getInt("id")%>')">
                <i class="layui-icon">&#xe640;</i>
            </button>
        </td>
    </tr>
