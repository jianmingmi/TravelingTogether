    ...
    <div class="nav02">
        <div class="nav-list">
            ...
            <ul>
                ...
                <li class="nav-list-top"><a class="menu-item" href="###" onclick="javascript:window.location.href='/jieban/jieban';"></a>发布结伴</li>
...
<li class="">
<div class="cover">
<img src="/images/1.png" alt="7日爆款元阳普者黑"/>
</div>
<div class="info">
<h3 class="title">
...
<li class="">
<div class="cover">
<img src="/images/2.png" alt="8日房车丝绸之路"/>
</div>
<div class="info">
<h3 class="title">
...
<li class="">
<div class="cover">
<img src="/images/3.png" alt="17日超值川青大环线">
</div>
<div class="info">
<h3 class="title">
...
<button class="col-right btn btn-green btn-large"  onclick="javascript:window.location.href='/jieban/jieban';"><i class="fa fa-plus"></i> 发布结伴
</button>
</div>
...
<%--<script>--%>
    ...
    <%--$('.theme .tab-list li').eq(0).css({'background':'#ff7200'});--%>
    <%--$('.theme .tab-list li').mouseenter(function () {--%>
        <%--$(this).css({'background':'#ff7200'});--%>
        <%--$('.theme .tab-list li').not($(this)).css({'background':'#fff'});--%>

        <%--idx=$(this).index('.theme .tab-list li');--%>

        <%--$('.theme .theme-product').eq(idx).show();--%>
        <%--$('.theme .theme-product').not($('.theme .theme-product').eq(idx)).hide();--%>
    <%--});--%>

    <%--$('.line-tab .tab-list li').eq(0).css({'background':'#ff7200'});--%>
<%--</script>--%>
</html>
