...
public class XmlUtils {
     ...
     * 通过xml字符获取document文档
     */
    public static Document getDocumentByString(String xmlstr) throws DocumentException {
    ...
    /**
     * 通过文件的路径获取xml的根element
     */
    public static Element getRootElementByFilePath(String path) {
        if (null == path) {
            return null;
        }
        Document document = null;
